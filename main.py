...
win.iconbitmap('icons/texteditoricon.ico')
...
#FILE COMMANDS
##file.add_command(label='New File',image=new_icon,compound=tk.LEFT,accelerator='Ctrl+N')
...
font_box.current(font_tuple.index('Perpetua'))
...
## left align button
left_align_icon = tk.PhotoImage(file='icons/align_left.png')
left_align_btn = ttk.Button(tool_bar, image=left_align_icon)
left_align_btn.grid(row=0, column=5, padx=5)

## center align button
center_align_icon = tk.PhotoImage(file='icons/align_center.png')
center_align_btn = ttk.Button(tool_bar, image=center_align_icon)
center_align_btn.grid(row=0, column=6, padx=5)

## right align button
right_align_icon = tk.PhotoImage(file='icons/align_right.png')
right_align_btn = ttk.Button(tool_bar, image=right_align_icon)
right_align_btn.grid(row=0, column=7, padx=5)
